...
void main() {
  ...
  test('should be a class of NumberTrivia entity', () async {
    // assert
    expect(tNumberTriviaModel, isA<NumberTrivia>());
  });

  group('fromJson', () {
    test('should return value model when JSON number is an integer', () async {
      // arrange
  ...
  group('toJson', (){
    test('should return a json map containing the propor data', () async {
      //act
      final result = tNumberTriviaModel.toJson();
      //assert
      final exptectedJsonMap = {
        "text": "Test Text",
        "number": 1,
      };

      expect(result, exptectedJsonMap);
    });
  });
}